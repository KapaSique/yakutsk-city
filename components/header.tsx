      ...
      <header className="sticky top-0 z-40 w-full border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            {/* Logo */}
            <Link href="/" className="flex items-center space-x-3 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-primary-light focus-visible:ring-offset-2 rounded-md">
            ...
            <nav className="hidden md:flex items-center space-x-6" aria-label="Основная навигация">
              <Link
                href="/about"
                className="text-sm font-medium text-gray-700 hover:text-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-light rounded-md px-2 py-1"
              >
                О департаменте
              </Link>
              <Link
