        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-primary hover:underline text-lg transition-colors duration-200"
                  >
                    8 (4112) 40-88-09
                  </a>
                </div>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-200">
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-semibold text-sm text-gray-500 mb-3">По имущественным вопросам</h4>
                <div className="space-y-3 ml-2">
                  <div>
                    <p className="font-medium text-sm mb-1">Отдел учёта и распоряжения муниципальной собственностью</p>
                    <p className="text-gray-600 text-sm">
                      <a href="tel:+74112408069" className="text-primary hover:underline transition-colors duration-200">8 (4112) 40-80-69</a>
                    </p>
                  </div>
                  <div>
                    <p className="font-medium text-sm mb-1">Отдел информатизации</p>
                    <p className="text-gray-600 text-sm">
                      <a href="tel:+74112408091" className="text-primary hover:underline transition-colors duration-200">8 (4112) 40-80-91</a>
                    </p>
                  </div>
                  <div>
                    <p className="font-medium text-sm mb-1">Юридический отдел</p>
                    <p className="text-gray-600 text-sm">
                      <a href="tel:+74112408098" className="text-primary hover:underline transition-colors duration-200">8 (4112) 40-80-98</a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-gray-200">
                <h4 className="font-semibold text-sm text-gray-500 mb-3">По земельным вопросам</h4>
                <div className="space-y-3 ml-2">
                  <div>
                    <p className="font-medium text-sm mb-1">Отдел образования земельных участков</p>
                    <p className="text-gray-600 text-sm">
                      <a href="tel:+74112326479" className="text-primary hover:underline transition-colors duration-200">8 (4112) 32-64-79</a>
                    </p>
                  </div>
                  <div>
                    <p className="font-medium text-sm mb-1">Отдел землеустройства</p>
                    <p className="text-gray-600 text-sm">
                      <a href="tel:+74112326478" className="text-primary hover:underline transition-colors duration-200">8 (4112) 32-64-78</a>
                    </p>
                  </div>
                  <div>
                    <p className="font-medium text-sm mb-1">Организационный отдел</p>
                    <p className="text-gray-600 text-sm">
                      <a href="tel:+74112326469" className="text-primary hover:underline transition-colors duration-200">8 (4112) 32-64-69</a>
                    </p>
                  </div>
                  <div>
                    <p className="font-medium text-sm mb-1">Приёмная МКУ АЗО</p>
                    <p className="text-gray-600 text-sm">
                      <a href="tel:+74112326460" className="text-primary hover:underline transition-colors duration-200">8 (4112) 32-64-60</a>
                    </p>
                  </div>
                  <div>
                    <p className="font-medium text-sm mb-1">Юридический отдел</p>
                    <p className="text-gray-600 text-sm">
                      <a href="tel:+74112326458" className="text-primary hover:underline transition-colors duration-200">8 (4112) 32-64-58</a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-gray-200">
                ...
                <div className="flex flex-col gap-2">
                  <a
                    ...
                    className="text-primary hover:underline inline-flex items-center gap-2 transition-colors duration-200"
                  >
                    ВКонтакте
